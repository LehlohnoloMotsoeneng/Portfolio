export const projects = [
  ...
  },
  {
    ...
    challenges: ['[ADD CHALLENGE]', '[ADD UX CONSIDERATIONS]'],
    results: ['[ADD RESULTS]'],
    lessons: ['[ADD WHAT I LEARNED]'],
    futureImprovements: ['[ADD FUTURE IMPROVEMENTS]'],
    github: '#',
  ...
  },
  {
    ...
    model: '[ADD MODEL]',
    testing: '[ADD TEST RESULTS]',
    challenges: ['[ADD CHALLENGE]', '[ADD DATA HANDLING CONSIDERATIONS]'],
    results: ['[ADD ACTUAL ACCURACY]', '[ADD TEST RESULTS]'],
    lessons: ['[ADD WHAT I LEARNED]'],
    futureImprovements: ['[ADD FUTURE IMPROVEMENTS]'],
    github: '#',
    liveDemo: '#',
  ...
  },
  {
    ...
    challenges: ['[ADD TEAM CHALLENGE]', '[ADD INTEGRATION CONSIDERATIONS]'],
    results: ['[ADD RESULTS]'],
    lessons: ['[ADD WHAT I LEARNED]'],
    futureImprovements: ['[ADD FUTURE IMPROVEMENTS]'],
